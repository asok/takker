...
RSpec.describe "Kept places", type: :request do
  let!(:user) do
    User.create!(
  ...
  before do
    ...
    user.kept_places.push(place)
  end

  describe 'POST create' do
    it "creates and adds place to kept_places" do
      post "/kept_places",
          params:  {place: {'id' => 'xyz', 'name' => 'foo'}}.to_json,
          headers: headers

      place1, place2, *rest = user.reload.kept_places
